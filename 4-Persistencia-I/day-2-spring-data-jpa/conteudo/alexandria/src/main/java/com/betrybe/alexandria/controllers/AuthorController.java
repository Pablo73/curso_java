...
public class AuthorController {
  ...
  public ResponseEntity<ResponseDTO<Author>> removeAuthorById(@PathVariable Long authorId) {
    Optional<Author> optionalAuthor = authorService.removeBookById(authorId);
    ...
    ResponseDTO<Author> responseDTO = new ResponseDTO<>("Author removido com sucesso!", null);
    return ResponseEntity.ok(responseDTO);
  }
  ...
  public ResponseEntity<ResponseDTO<Author>> getAuthorById(@PathVariable Long authorId) {
    ...
    ResponseDTO<Author> responseDTO = new ResponseDTO<>("Author encontrado com sucesso!", optionalAuthor.get());
    return ResponseEntity.ok(responseDTO);
  }
